    ...
    <div className="bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto py-3 px-4">
          <div className="flex items-center gap-2 text-sm">
            <Link
              href="/"
              className="text-gray-600 hover:text-red-600 transition-colors flex items-center justify-center gap-1"
            >
      ...
      <div className="bg-gradient-to-r from-red-500/10 to-red-600/10 py-6 px-4">
        <div className="container mx-auto">
          <h1 className="uppercase text-2xl md:text-3xl font-bold text-center text-red-600 mb-3">
            🔥 Flash sale - 80% off 🔥
          </h1>
            ...
            <p className="text-center text-red-500 text-sm md:text-base font-semibold animate-pulse ">
              ...
              {Math.abs(
                (
                  ...
                  .split("")
                  .reduce((a, b) => a + b.charCodeAt(0), 0) % 30
              )}{" "}
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Product image */}
          {product.image && (
            <div className="aspect-square rounded-2xl overflow-hidden shadow-lg bg-white p-4">
          ...
          <div className="flex flex-col gap-4 px-1">
            ...
            <div className="flex items-center gap-2 bg-red-50 p-2 rounded-lg">
              ...
              <span className="text-red-600 font-medium text-sm">
                You save {formatPrice(product.price * 5 - product.price)}!
              </span>
            </div>
              ...
              <span>
                {Math.abs(
                  (
                    ...
                    .split("")
                    .reduce((a, b) => a + b.charCodeAt(0), 0) % 50
                ) + 10}{" "}
